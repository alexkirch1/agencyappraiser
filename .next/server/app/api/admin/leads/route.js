(()=>{var a={};a.id=7747,a.ids=[7747],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},17640:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>H,patchFetch:()=>G,routeModule:()=>C,serverHooks:()=>F,workAsyncStorage:()=>D,workUnitAsyncStorage:()=>E});var d={};c.r(d),c.d(d,{DELETE:()=>B,GET:()=>z,PATCH:()=>A,dynamic:()=>x});var e=c(77094),f=c(74863),g=c(62310),h=c(57512),i=c(71174),j=c(261),k=c(46328),l=c(65338),m=c(82298),n=c(25641),o=c(57943),p=c(28253),q=c(71387),r=c(16892),s=c(86439),t=c(27906),u=c(71367),v=c(18095),w=c(63541);let x="force-dynamic";async function y(){try{await (0,v.A)`
    ...
    `,f=await (0,v.A)`
      ...
      ORDER BY week ASC
    `;return u.NextResponse.json({leads:a,trashedLeads:b,stats:c[0],stageStats:d,sourceStats:e,weeklyTrend:f})}catch(a){return console.error("[v0] admin leads fetch error:",a),u.NextResponse.json({error:"Failed to fetch leads"},{status:500})}}async function A(a){if(!await (0,w.nm)())return u.NextResponse.json({error:"Unauthorized"},{status:401});try{let{id:b,stage:c,archived:d,archive_reason:e,notes:f,restore:g,trash:h}=await a.json();if(!b||isNaN(Number(b)))return u.NextResponse.json({error:"Invalid lead id"},{status:400});if(!0===h)return await (0,v.A)`
        UPDATE leads SET deleted_at = NOW(), last_activity = NOW()
        WHERE id = ${Number(b)}
      `,u.NextResponse.json({success:!0});if(!0===g)return await (0,v.A)`
        UPDATE leads SET deleted_at = NULL, last_activity = NOW()
        WHERE id = ${Number(b)}
      `,u.NextResponse.json({success:!0});if("boolean"==typeof d)return await (0,v.A)`
        UPDATE leads 
        SET archived = ${d},
